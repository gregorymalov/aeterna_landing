      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-white">Two-Phase</span>{' '}
            <span className="text-purple-primary">Gambit</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Growth with reduced risks through phased development
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-dark-card rounded-2xl p-8 border border-purple-primary/30 hover:border-purple-primary/50 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Phase I: Raritygram</h3>
              ...
              <p className="text-gray-300 text-center italic">
                "Creating a legally sound, revenue-generating asset"
              </p>
            </div>
            ...
            <div className="bg-dark-card rounded-2xl p-8 border border-yellow-accent/30 hover:border-yellow-accent/50 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Phase II: Umbra</h3>
              ...
              <p className="text-gray-300 text-center italic">
                "Capturing a high-margin market protected by a technological barrier"
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-primary/10 to-yellow-accent/10 border border-purple-primary/30 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-white mb-6 text-center">
              A de-risked approach to dominance
            </h3>
            <p className="text-lg text-gray-300 leading-relaxed text-center max-w-4xl mx-auto">
              We de-risk your investment. <span className="text-purple-primary font-semibold">Phase I</span> creates a stable, 
              brand-safe platform. Its success gives us a <span className="text-yellow-accent font-semibold">'call option'</span> on 
              the huge, competition-protected NSFW market, which our main competitors are structurally unable to enter 
              due to API restrictions from leading AI providers.
            </p>
          </div>
        </div>
      </div>
