...
const RoadmapSection = () => {
  ...
  const phases = [
    ...
    },
    {
      ...
      description: "За 6 месяцев: запуск SFW-платформы Aeterna, привлечение >100 авторов, активация первых потоков дохода.",
      metrics: [
    ...
    },
    {
      ...
      description: "Масштабирование SFW-базы, достижение прибыльности Aeterna, завершение НИОКР по собственной AI-модели для Umbra.",
      metrics: [
        "1000+ авторов",
